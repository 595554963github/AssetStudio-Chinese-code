...
namespace AssetStudio
{
    public class Object
    {
        ...
        public Object(ObjectReader reader)
        {
            ...
            Logger.Verbose($"尝试读取对象{type} with {m_PathID} in file {assetsFile.fileName}, 从偏移0x{reader.byteStart:X8}开始，尺寸为0x{byteSize:X8} !!");
        ...
        {
            Logger.Verbose($"转储对象的原始字节{m_PathID}在文件中{assetsFile.fileName}...");
            reader.Reset();
